...
#ifndef DEFAULT_GLES
#define DEFAULT_GLES nullptr
#endif
#ifndef DEFAULT_EGL
#define DEFAULT_EGL nullptr
#endif

void *gles = nullptr, *egl = nullptr, *bcm_host = nullptr, *vcos = nullptr, *gbm = nullptr, *drm = nullptr;
#ifndef _WIN32
#ifndef NO_GBM
...
void load_libs() {
    ...
    if (!gles_override) {
        ...
        if (! gles_override) {
            const char *bcm_host_name[] = {"libbcm_host", nullptr};
            const char *vcos_name[] = {"libvcos", nullptr};
            bcm_host = open_lib(bcm_host_name, nullptr);
            vcos = open_lib(vcos_name, nullptr);
        }
#endif
    }
