...
void gl4es_blitTexture_gles2(GLuint texture,
    ...
    if(!glstate->blit) {
        ...
        gles_glShaderSource( glstate->blit->pixelshader, 1, (const char**) src, nullptr );
        ...
        if (!success)
        {
            ...
            char log[400];
            gles_glGetShaderInfoLog(glstate->blit->pixelshader, 399, nullptr, log);
            SHUT_LOGE("Failed to produce blit fragment shader.\n%s", log);
            free(glstate->blit);
            glstate->blit = nullptr;
        }
    
        src[0] = _blit_fsh_alpha;
        glstate->blit->pixelshader_alpha = gles_glCreateShader( GL_FRAGMENT_SHADER );
        gles_glShaderSource( glstate->blit->pixelshader_alpha, 1, (const char**) src, nullptr );
        ...
        if (!success)
        {
            LOAD_GLES2_(glGetShaderInfoLog);
            char log[400];
            gles_glGetShaderInfoLog(glstate->blit->pixelshader_alpha, 399, nullptr, log);
        ...
        gles_glShaderSource( glstate->blit->vertexshader, 1, (const char**) src, nullptr );
        ...
        if( !success )
        {
            LOAD_GLES2_(glGetShaderInfoLog);
            char log[400];
            gles_glGetShaderInfoLog(glstate->blit->vertexshader, 399, nullptr, log);
        ...
        gles_glShaderSource( glstate->blit->vertexshader_alpha, 1, (const char**) src, nullptr );
        ...
        if( !success )
        {
            LOAD_GLES2_(glGetShaderInfoLog);
            char log[400];
            gles_glGetShaderInfoLog(glstate->blit->vertexshader_alpha, 399, nullptr, log);
